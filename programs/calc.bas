...
START:
  ...
  GOSUB STARTPRG
  REM set the text color and highlight (for the menu)
  C = 3
  H = 11
  REM set the box color
  T = 2
  MOVE 30 13
  PRINT "Calculating..."
GOTO MAIN
...
COLCHANGE:
  ...
  $5 = "Input a new color for outline, 1-255"
  $6 = "Input a new text color, 1-15"
  V = 0
  GOSUB DINBOX
  $E = "Invalid color"
  ...
  T = A
  C = B
  $5 = "Input a new highlight color, 1-15"
  $6 = ""
  V = 0
  GOSUB INPBOX
  $E = "Invalid color"
...
ABOUT:
  ...
  $8 = "Written in TorchOS BASIC"
  $9 = "Thanks to the TorchOS developers"
  GOSUB MESBOX

  $5 = "Uses the MB++ Library, version 3.0"
  $6 = "A great TUI library"
  $7 = "Created by Joshua Beck"
  $8 = "Mail: rohan.bharatia@outlook.com"
