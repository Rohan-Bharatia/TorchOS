...
rem A text drawing program for TorchOS
rem Copyright (C) Joshua Beck 2002
rem Mail: rohan.bharatia@outlook.com
...
setback:
  gosub savevar
  $T = "         Background Color"
  $5 = "What color do you want to set?"
...
changekey:
  ...
  $T = "          Change Key"
  $5 = "Enter the background color"
  $6 = "Enter the foreground color"
  v = 0
  gosub dinbox
...
setmapcolor:
  gosub savevar
  $T = "         Set Background"
  $5 = "What color do you want to use for"
...
help_about:
  ...
  $7 = "Email: rohan.bharatia@outlook.com"
...
help_keymap:
  ...
  $8 = "and uses the color white but you"
...
help_files:
  ...
  $6 = "This supports titles, color, custom"
